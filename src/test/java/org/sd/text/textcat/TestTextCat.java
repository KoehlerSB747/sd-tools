...
public class TestTextCat extends TestCase {
  ...
  public void testTexts() throws IOException {
    ...
    doTestTexts(textCat, FileUtil.getFile(this.getClass(), LANGUAGE_TEST_FILE_DIR1), false, false);
    doTestTexts(textCat, FileUtil.getFile(this.getClass(), LANGUAGE_TEST_FILE_DIR2), false, false);
  }
